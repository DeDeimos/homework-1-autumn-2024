...
- **Кнопка "Выход"**:
  ...
  - Если действие авторизационной cookie закончилось, то при данном условии при первой загрузке страницы, если выход предварительно не совершался, автоматический выход из системы не происходит (перенаправление на страницу авторизации), а при нажатии "Продолжить" появляется ошибка "Что-то пошло не так".❌
    > **[Баг]**
    >
